  ...
  module V1
    module Admin
      class ItemsController < BaseController
        ...
        # GET /api/v1/admin/items?shop_id=1&q=adobo
        def index
          scope = Item.order(created_at: :desc)
          ...
          render json: { items: paginate(scope).map { |i| ItemSerializer.call(i) }, meta: pagination_meta(scope) }
        end
