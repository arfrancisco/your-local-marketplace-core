  ...
  def call(user)
    {
      ...
      sms_notify_order_placed: user.sms_notify_order_placed,
      sms_notify_order_accepted: user.sms_notify_order_accepted,
      sms_notify_order_ready: user.sms_notify_order_ready,
      sms_notify_order_completed: user.sms_notify_order_completed,
