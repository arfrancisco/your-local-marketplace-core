...
export default defineConfig(({ command }) => ({
  ...
  test: {
    ...
    // Force the default relative /shops path regardless of what local dev's
    ...
    // they're named *.local. Mirrors customer-web's own
    // VITE_VENDOR_WEB_BASE_URL pin in its vite.config.ts.
